...
profile:
  ...
  more_info: >
    <p><strong>PharmAI Research Group</strong></p>
    <p>Karadeniz Technical University</p>
    <p>Drug and Pharmaceutical Technology Application & Research Center (ILAFAR)</p>
    <p>Kanuni Campus, 61080 Trabzon, Türkiye</p>
    <p><a href="mailto:hulya@ktu.edu.tr">hulya@ktu.edu.tr</a></p>
...
Interested in joining as a **student, visiting scholar, or partner lab**? Reach out at **[hulya@ktu.edu.tr](mailto:hulya@ktu.edu.tr)** with a short bio and interests.
...
_This page auto-lists selected publications and recent posts if available in your repository. To feature works, mark entries in `_bibliography/papers.bib` with `selected={true}`; news items go in `_news/`, and posts in `_posts/`._
